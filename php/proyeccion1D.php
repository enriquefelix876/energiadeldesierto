    ...
    $inicioVerano = "Marzo";
        ...
        if($inicioVerano == "Febrero"){
            ...
            if($mes == "Febrero"){
                ...
                //Consumo por mes
                $consumoMarzo = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoAbril = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoMayo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoJunio = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
            ...
            if($mes == "Marzo"){
                ...
                //Consumo por mes
                $consumoAbril = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoMayo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoJunio = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                ...
                $consumoMarzo = desgloseConsumoPorMesVerano($consumoPorMes['mes12'], 175, 225, 200, 0.706, 0.831, 1.062, 2.835);
        ...
        if($inicioVerano == "Marzo"){
            ...
            if($mes == "Febrero"){
                ...
                $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoOctubre = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 125, 0.793, 0.956, 2.802);
                $consumoNoviembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEnero = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.796, 0.960, 2.813);
            ...
            if($mes == "Marzo"){
                ...
                $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoOctubre = desgloseConsumoPorMesInvierno($consumoPorMes['mes7'], 75, 125, 0.793, 0.956, 2.802);
                $consumoNoviembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEnero = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.796, 0.960, 2.813);
        ...
        if($inicioVerano == "Abril"){
            ...
            if($mes == "Febrero"){
                ...
                $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoOctubre = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoNoviembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEnero = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.796, 0.960, 2.813);
                $consumoFebrero = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.799, 0.964, 2.824);
            ...
            if($mes == "Marzo"){
                ...
                $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoOctubre = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoNoviembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEnero = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.796, 0.960, 2.813);
                $consumoFebrero = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.799, 0.964, 2.824);
        ...
        if($inicioVerano == "Mayo"){
            ...
            if($mes == "Febrero"){
                ...
                $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoOctubre = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoNoviembre = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoDiciembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEnero = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.796, 0.960, 2.813);
                $consumoFebrero = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.799, 0.964, 2.824);
            ...
            if($mes == "Marzo"){
                ...
                $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoOctubre = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoNoviembre = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 175, 225, 200, 0.697, 0.822, 1.050, 2.802);
                $consumoDiciembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEnero = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.796, 0.960, 2.813);
                $consumoFebrero = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.799, 0.964, 2.824);
                $consumoMarzo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.802, 0.968, 2.835);
