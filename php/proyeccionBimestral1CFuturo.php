<?php 
    ...
    if($inicioVerano == "Febrero"){
        ...
        if($mes == "Diciembre"){
            ...
            $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoMarzoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
        ...
        if($mes == "Enero"){
            ...
            $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoAbrilFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
        ...
        if($mes == "Febrero"){
            ...
            $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoMarzoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
        ...
        if($mes == "Marzo"){
            ...
            $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoAbrilFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
    ...
    if($inicioVerano == "Marzo"){
        //En caso de que el ultimo mes sea Diciembre
        if($mes == "Diciembre"){
            $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
        ...
        if($mes == "Febrero"){
            $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 150, 200, 0.793, 0.956, 2.802);
            $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
    ...
    if($inicioVerano == "Abril"){
        ...
        //En caso de que el ultimo mes sea Enero
        if($mes == "Enero"){
            $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
        ...
        if($mes == "Marzo"){
            $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 150, 200, 0.793, 0.956, 2.802);
            $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
    ...
    if($inicioVerano == "Mayo"){
        ...
        if($mes == "Diciembre"){
            ...
            $consumoMarzoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 150, 200, 0.793, 0.956, 2.802);
            $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 150, 200, 0.793, 0.956, 2.802);
            $consumoNoviembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
        }
        //En caso de que el ultimo mes sea Enero
        if($mes == "Enero"){
            $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
        ...
        //En caso de que el ultimo mes sea Febrero
        if($mes == "Febrero"){
            $consumoNoviembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
            $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 300, 300, 0.697, 0.822, 1.050, 2.802);
