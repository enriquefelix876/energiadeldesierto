...
function generarProyeccion1FBimestral($consumoPorMes){
    ...
    if($inicioVerano == "Febrero"){
        ...
        if($mes == "Diciembre"){
            ...
            $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoMayo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoMarzo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
        ...
        if($mes == "Enero"){
            ...
            $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoJunio = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoAbril = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
        ...
        if($mes == "Febrero"){
            ...
            $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoMayo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoMarzo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
        ...
        if($mes == "Marzo"){
            ...
            $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoJunio = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoAbril = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
    ...
    if($inicioVerano == "Marzo"){
        //En caso de que el ultimo mes sea Diciembre
        if($mes == "Diciembre"){
            $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoMayo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
        ...
        if($mes == "Febrero"){
            $consumoNoviembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 150, 250, 0.793, 0.956, 2.802);
            $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoMayo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
    ...
    if($inicioVerano == "Abril"){
        ...
        //En caso de que el ultimo mes sea Enero
        if($mes == "Enero"){
            $consumoOctubre = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoJunio = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
        ...
        if($mes == "Marzo"){
            $consumoDiciembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 150, 250, 0.793, 0.956, 2.802);
            $consumoOctubre = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoAgosto = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoJunio = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
    ...
    if($inicioVerano == "Mayo"){
        ...
        if($mes == "Diciembre"){
            ...
            $consumoMarzo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 150, 250, 0.793, 0.956, 2.802);
            $consumoEnero = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 150, 250, 0.793, 0.956, 2.802);
            $consumoNoviembre = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
        }
        //En caso de que el ultimo mes sea Enero
        if($mes == "Enero"){
            $consumoOctubre = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
        ...
        //En caso de que el ultimo mes sea Febrero
        if($mes == "Febrero"){
            $consumoNoviembre = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoSeptiembre = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
            $consumoJulio = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 600, 1800, 2600, 0.583, 0.726, 1.768, 2.802);
