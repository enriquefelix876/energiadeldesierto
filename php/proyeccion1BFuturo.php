<?php 
    ...
    if($inicioVerano == "Febrero"){
        ...
        if($mes == "Febrero"){
            ...
            //Consumo por mes
            $consumoMarzoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 125, 100, 0.697, 0.822, 2.802);
            $consumoAbrilFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 125, 100, 0.697, 0.822, 2.802);
            $consumoMayoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 125, 100, 0.697, 0.822, 2.802);
            $consumoJunioFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 125, 100, 0.697, 0.822, 2.802);
            $consumoJulioFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 125, 100, 0.697, 0.822, 2.802);
            $consumoAgostoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes6'], 125, 100, 0.697, 0.822, 2.802);
            ...
            $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 125, 100, 0.703, 0.828, 2.824);            
        }
        ...
        if($mes == "Marzo"){
            ...
            //Consumo por mes
            $consumoAbrilFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 125, 100, 0.697, 0.822, 2.802);
            $consumoMayoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 125, 100, 0.697, 0.822, 2.802);
            $consumoJunioFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 125, 100, 0.697, 0.822, 2.802);
            $consumoJulioFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 125, 100, 0.697, 0.822, 2.802);
            $consumoAgostoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 125, 100, 0.697, 0.822, 2.802);
            ...
            $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 125, 100, 0.703, 0.828, 2.824);
            $consumoMarzoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 125, 100, 0.706, 0.831, 2.835);            
        }
    ...
    if($inicioVerano == "Marzo"){
        ...
        if($mes == "Febrero"){
            ...
            $consumoJulioFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 125, 100, 0.697, 0.822, 2.802);
            $consumoAgostoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes6'], 125, 100, 0.697, 0.822, 2.802);
            $consumoSeptiembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes7'], 125, 100, 0.697, 0.822, 2.802);
            $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 100, 0.793, 0.956, 2.802);
            $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 100, 0.793, 0.956, 2.802);
            $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 100, 0.793, 0.956, 2.802);
            $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 100, 0.796, 0.960, 2.813);
        ...
        if($mes == "Marzo"){
            ...
            $consumoJulioFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 125, 100, 0.697, 0.822, 2.802);
            $consumoAgostoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 125, 100, 0.697, 0.822, 2.802);
            $consumoSeptiembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes6'], 125, 100, 0.697, 0.822, 2.802);
            $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes7'], 75, 100, 0.793, 0.956, 2.802);
            $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 100, 0.793, 0.956, 2.802);
            $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 100, 0.793, 0.956, 2.802);
            $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 100, 0.796, 0.960, 2.813);
    ...
    if($inicioVerano == "Abril"){
        ...
        if($mes == "Febrero"){
            ...
            $consumoAgostoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes6'], 125, 100, 0.697, 0.822, 2.802);
            $consumoSeptiembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes7'], 125, 100, 0.697, 0.822, 2.802);
            $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 125, 100, 0.697, 0.822, 2.802);
            $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 100, 0.793, 0.956, 2.802);
            $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 100, 0.793, 0.956, 2.802);
            $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 100, 0.796, 0.960, 2.813);
            $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 100, 0.799, 0.964, 2.824);            
        ...
        if($mes == "Marzo"){
            ...
            $consumoAgostoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 125, 100, 0.697, 0.822, 2.802);
            $consumoSeptiembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes6'], 125, 100, 0.697, 0.822, 2.802);
            $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes7'], 125, 100, 0.697, 0.822, 2.802);
            $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 100, 0.793, 0.956, 2.802);
            $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 100, 0.793, 0.956, 2.802);
            $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 100, 0.796, 0.960, 2.813);
            $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 100, 0.799, 0.964, 2.824);
    ...
    if($inicioVerano == "Mayo"){
        ...
        if($mes == "Febrero"){
            ...
            $consumoSeptiembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes7'], 125, 100, 0.697, 0.822, 2.802);
            $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 125, 100, 0.697, 0.822, 2.802);
            $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 125, 100, 0.697, 0.822, 2.802);
            $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 100, 0.793, 0.956, 2.802);
            $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 100, 0.796, 0.960, 2.813);
            $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 100, 0.799, 0.964, 2.824);            
        }
        ...
        if($mes == "Marzo"){
            ...
            $consumoSeptiembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes6'], 125, 100, 0.697, 0.822, 2.802);
            $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes7'], 125, 100, 0.697, 0.822, 2.802);
            $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 125, 100, 0.697, 0.822, 2.802);
            $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 100, 0.793, 0.956, 2.802);
            $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 100, 0.796, 0.960, 2.813);
            $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 100, 0.799, 0.964, 2.824);
            $consumoMarzoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 100, 0.802, 0.968, 2.835);            
