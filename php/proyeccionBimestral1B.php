<?php 
    ...
    function generarProyeccion1BBimestral($consumoPorMes){
    ...
    if($inicioVerano == "Febrero"){
        ...
        if($mes == "Diciembre"){
            ...
            $consumoJulio = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 250, 200, 0.697, 0.822, 2.802);
            $consumoMayo = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
            $consumoMarzo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 250, 200, 0.697, 0.822, 2.802);
        ...
        if($mes == "Enero"){
            ...
            $consumoAgosto = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 250, 200, 0.697, 0.822, 2.802);
            $consumoJunio = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
            $consumoAbril = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 250, 200, 0.697, 0.822, 2.802);
        ...
        if($mes == "Febrero"){
            ...
            $consumoJulio = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
            $consumoMayo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 250, 200, 0.697, 0.822, 2.802);
            $consumoMarzo = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 250, 200, 0.697, 0.822, 2.802);
        ...
        if($mes == "Marzo"){
            ...
            $consumoAgosto = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
            $consumoJunio = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 250, 200, 0.697, 0.822, 2.802);
            $consumoAbril = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 250, 200, 0.697, 0.822, 2.802);
    ...
    if($inicioVerano == "Marzo"){
        //En caso de que el ultimo mes sea Diciembre
        if($mes == "Diciembre"){
            $consumoSeptiembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 250, 200, 0.697, 0.822, 2.802);
            $consumoJulio = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 250, 200, 0.697, 0.822, 2.802);
            $consumoMayo = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
        ...
        if($mes == "Febrero"){
            $consumoNoviembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 150, 200, 0.793, 0.956, 2.802);
            $consumoSeptiembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 250, 200, 0.697, 0.822, 2.802);
            $consumoJulio = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
            $consumoMayo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 250, 200, 0.697, 0.822, 2.802);
    ...
    if($inicioVerano == "Abril"){
        ...
        //En caso de que el ultimo mes sea Enero
        if($mes == "Enero"){
            $consumoOctubre = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 250, 200, 0.697, 0.822, 2.802);
            $consumoAgosto = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 250, 200, 0.697, 0.822, 2.802);
            $consumoJunio = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
        ...
        if($mes == "Marzo"){
            $consumoDiciembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 150, 200, 0.793, 0.956, 2.802);
            $consumoOctubre = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 250, 200, 0.697, 0.822, 2.802);
            $consumoAgosto = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
            $consumoJunio = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 250, 200, 0.697, 0.822, 2.802);
    ...
    if($inicioVerano == "Mayo"){
        ...
        if($mes == "Diciembre"){
            ...
            $consumoMarzo = desgloseConsumoPorMesInvierno($consumoPorMes['mes4'], 150, 200, 0.793, 0.956, 2.802);
            $consumoEnero = desgloseConsumoPorMesInvierno($consumoPorMes['mes5'], 150, 200, 0.793, 0.956, 2.802);
            $consumoNoviembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes6'], 250, 200, 0.697, 0.822, 2.802);
        }
        //En caso de que el ultimo mes sea Enero
        if($mes == "Enero"){
            $consumoOctubre = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 250, 200, 0.697, 0.822, 2.802);
        ...
        //En caso de que el ultimo mes sea Febrero
        if($mes == "Febrero"){
            $consumoNoviembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes1'], 250, 200, 0.697, 0.822, 2.802);
            $consumoSeptiembre = desgloseConsumoPorMesInvierno($consumoPorMes['mes2'], 250, 200, 0.697, 0.822, 2.802);
            $consumoJulio = desgloseConsumoPorMesInvierno($consumoPorMes['mes3'], 250, 200, 0.697, 0.822, 2.802);
