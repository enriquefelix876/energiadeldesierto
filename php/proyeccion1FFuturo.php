    ...
    $inicioVerano = "Marzo";
        ...
        if($inicioVerano == "Febrero"){
            ...
            if($mes == "Febrero"){
                ...
                //Consumo por mes
                $consumoMarzoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAbrilFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
            ...
            if($mes == "Marzo"){
                ...
                //Consumo por mes
                $consumoAbrilFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes1'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                ...
                $consumoMarzoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes12'], 300, 900, 1300, 0.589, 0.735, 1.789, 2.835);
        ...
        if($inicioVerano == "Marzo"){
            ...
            if($mes == "Febrero"){
                ...
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 125, 0.793, 0.956, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.796, 0.960, 2.813);
            ...
            if($mes == "Marzo"){
                ...
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes7'], 75, 125, 0.793, 0.956, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.796, 0.960, 2.813);
        ...
        if($inicioVerano == "Abril"){
            ...
            if($mes == "Febrero"){
                ...
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.796, 0.960, 2.813);
                $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.799, 0.964, 2.824);
            ...
            if($mes == "Marzo"){
                ...
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes8'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.796, 0.960, 2.813);
                $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.799, 0.964, 2.824);
        ...
        if($inicioVerano == "Mayo"){
            ...
            if($mes == "Febrero"){
                ...
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.796, 0.960, 2.813);
                $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.799, 0.964, 2.824);
            ...
            if($mes == "Marzo"){
                ...
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.796, 0.960, 2.813);
                $consumoFebreroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.799, 0.964, 2.824);
                $consumoMarzoFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.802, 0.968, 2.835);
