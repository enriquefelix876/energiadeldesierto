    ...
    $inicioVerano = "Marzo";
        ...
        if($inicioVerano == "Febrero"){
            ...
            if($mes == "Enero"){
                ...
                $consumoMarzoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAbrilFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
            ...
            if($mes == "Febrero"){
                ...
                $consumoMarzoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAbrilFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
            ...
            if($mes == "Marzo"){
                ...
                $consumoMarzoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes2'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAbrilFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes3'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoMayoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes4'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJunioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes5'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
        ...
        if($inicioVerano == "Marzo"){
            ...
            if($mes == "Enero"){
                ...
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes10'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.793, 0.956, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.793, 0.956, 2.802);
            }
            ...
            if($mes == "Febrero"){
                ...
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.793, 0.956, 2.802);
            ...
            if($mes == "Marzo"){
                ...
                $consumoJulioFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes6'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes9'], 75, 125, 0.793, 0.956, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.796, 0.960, 2.813);
        ...
        if($inicioVerano == "Abril"){
            ...
            if($mes == "Enero"){
                ...
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes10'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes11'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.793, 0.956, 2.802);
            }
            ...
            if($mes == "Febrero"){
                ...
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes10'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.793, 0.956, 2.802);
            ...
            if($mes == "Marzo"){
                ...
                $consumoAgostoFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes7'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes10'], 75, 125, 0.793, 0.956, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.796, 0.960, 2.813);
        ...
        if($inicioVerano == "Mayo"){
            ...
            if($mes == "Enero"){
                ...
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes10'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes11'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes12'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
            }
            ...
            if($mes == "Febrero"){
                ...
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes10'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes11'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.793, 0.956, 2.802);
            ...
            if($mes == "Marzo"){
                ...
                $consumoSeptiembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes8'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoOctubreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes9'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoNoviembreFuturo = desgloseConsumoPorMesVerano($consumoPorMes['mes10'], 300, 900, 1300, 0.583, 0.726, 1.768, 2.802);
                $consumoDiciembreFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes11'], 75, 125, 0.793, 0.956, 2.802);
                $consumoEneroFuturo = desgloseConsumoPorMesInvierno($consumoPorMes['mes12'], 75, 125, 0.796, 0.960, 2.813);
